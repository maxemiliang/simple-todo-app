!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){var r=n(1),i=[],o=r.get("/api/get");o.done(function(e){i=e.reverse();var t=r(".todos");t.empty(),i.forEach(function(e,n,i){r('<li id="item-'+n+'" class="list-group-item line-wrap">'+e+"</li>").appendTo(t)})}),setInterval(function(){var e=r.get("/api/get");e.done(function(e){i=e.reverse();var t=r(".todos");t.empty(),i.forEach(function(e,n,i){r('<li id="item-'+n+'" class="list-group-item line-wrap">'+e+"</li>").appendTo(t)})})},3e3),r(".todo").submit(function(e){e.preventDefault();var t=r.post("/api/add",{text:r("#todoToAdd").val()});t.done(function(e){i=e.reverse();var t=r(".todos");t.empty(),i.forEach(function(e,n,i){r('<li id="item-'+n+'" class="list-group-item line-wrap">'+e+"</li>").appendTo(t)})})})},function(e,t,n){var r,i;/*!
